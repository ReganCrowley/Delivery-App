...
/**
 * 
 * Inspired from https://codepen.io/ivjose/pen/EyjGKa
 */
            ...
            <div className="row">
                    ...
                    <div className="callout credit">
                        <div className="row">
                            <div className="small-6 columns">
                                <h1 className="credit__bank" style={{ color: "white" }}>My Bank</h1>
                            </div>
                            <div className="small-6 columns">
                ...
                <div className="small-5 columns end">
                    <div className="callout margin-top50">
                        <label style={{ textAlign: "left" }}>NAME
                            <input type="text" onChange={this.nameChange.bind(this)} />
                        </label>
                        <label style={{ textAlign: "left" }}>NUMBER
                            <input type="text" maxLength="16" onChange={this.numberChange.bind(this)} />
                        </label>
                        <div className="row">
                            <label className="column" style={{ textAlign: "left" }}>EXPIRATION DATE</label>
                        ...
                        <div className="row">
                            <div className="small-4 column">
                                <label style={{ textAlign: "left" }}>CCV
